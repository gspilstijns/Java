...
public class HepatitisB extends Vaccinatie{
    ...
    @Override
    void informeren() {
        //System.out.println("\tInformeer: Informatiebrocure Hepatitis-B aan " + getPatient().getNaam() + " overhandigd");
        VaccinatieLogger.log().info("\tInformeer: Informatiebrocure Hepatitis-B aan " + getPatient().getNaam() + " overhandigd");
    }
    ...
    void nazorgen() {
        ...
        sb.append(getPatient().getNaam()+" blijft nog 15 min wachten en mag dan naar huis\n\t\t");
        sb.append("Dokter voltooid de registratie van de Hepatitis-B vaccinatie\n");
        sb.append("-------------------------------------------------------------------------");
        //System.out.println(sb);
        VaccinatieLogger.log().info(sb);
    }
